...
/** lucide-react v1 dropped brand marks, so the GitHub glyph is inlined. */
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-5 py-8 sm:flex-row sm:items-center sm:justify-between sm:px-8">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="focus-ring inline-flex items-center gap-1.5 rounded-full text-sm text-muted-foreground transition-colors hover:text-foreground"
          >
