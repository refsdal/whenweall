/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a2d22ac8d0778e5b9c394c25c70ca2ce)
// Runtime types generated with workerd@1.20260820.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	EMAIL: SendEmail;
	RATE_LIMITER: RateLimit;
	APP_URL: "https://test.whenweall.com" | "https://whenweall.com";
	APP_ENV: "production";
	EMAIL_FROM: "whenweall test <no-reply@whenweall.com>" | "whenweall <no-reply@whenweall.com>";
	TURNSTILE_SITE_KEY: "0x4AAAAAAEcpi42QywKz2sSm";
	STRIPE_PRICE_PREMIUM_MONTHLY: "price_1U8k6tDHpY37Lq0GWCCYcQnX" | "price_1U8k2WDqZd85ftHmUfw4OH8O";
	STRIPE_PRICE_PREMIUM_YEARLY: "price_1U8k6tDHpY37Lq0G6P3Q3Qkz" | "price_1U8k2WDqZd85ftHmIqsuL2Uw";
	...
	POLL_ROOM: DurableObjectNamespace<import("./src/server").PollRoom>;
	BOOKING_ROOM: DurableObjectNamespace<import("./src/server").BookingRoom>;
	STATS_ROOM: DurableObjectNamespace<import("./src/server").StatsRoom>;
	RATE_LIMIT_ROOM: DurableObjectNamespace<import("./src/server").RateLimitRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "PollRoom" | "BookingRoom" | "StatsRoom" | "RateLimitRoom";
	}
	interface TestEnv {
		DB: D1Database;
		EMAIL: SendEmail;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "APP_ENV" | "EMAIL_FROM" | "TURNSTILE_SITE_KEY" | "STRIPE_PRICE_PREMIUM_MONTHLY" | "STRIPE_PRICE_PREMIUM_YEARLY" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "TURNSTILE_SECRET_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ENABLE_TEST_ROUTES">> {}
}
